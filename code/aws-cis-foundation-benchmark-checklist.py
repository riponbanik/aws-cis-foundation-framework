...
def lambda_handler(event, context):
    ...
    global S3_WEB_REPORT
    global S3_WEB_REPORT_BUCKET
    global END_REPORT_URL_TO_SNS
    ...
    try:
        if event['configRuleId']:
            ...
            if rule_parameters['s3BucketName']:                
               S3_WEB_REPORT         = True
               S3_WEB_REPORT_BUCKET  = rule_parameters['s3BucketName']
               print("Input Parameter - s3BucketName:" + S3_WEB_REPORT_BUCKET)

            if rule_parameters['snsTopicArn']:   
               SEND_REPORT_URL_TO_SNS = True
               SNS_TOPIC_ARN = rule_parameters['snsTopicArn']
               print("Input Parameter - snsTopicArn:" + SNS_TOPIC_ARN)
